...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      '.ibd-pick{margin-top:14px;border:0;border-radius:10px;background:#4f6ef7;color:#fff;',
      'font-size:13px;font-weight:600;padding:11px 22px;cursor:pointer;}',
      '.ibd-pick:hover{background:#3f5ce6;}',
      ...
      '.ibd-url:focus{border-color:#4f6ef7;box-shadow:0 0 0 3px rgba(79,110,247,.14);}',
      ...
      '.ibd-bar{height:100%;width:0;background:#4f6ef7;transition:width .18s;}',
